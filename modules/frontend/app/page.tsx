...
const TRANSLATIONS = {
  English: {
    ...
    val_sick_details: "Requesting sick leave for Today.",
  ...
  Swedish: {
    ...
    val_sick_details: "Ansökan om sjukfrånvaro för idag.",
  ...
  Arabic: {
    ...
    val_sick_details: "طلب إجازة مرضية لهذا اليوم.",
